...
// Upload efetuado com sucesso, exibe uma mensagem e um link para o arquivo
	...
	mysql_query("INSERT INTO `ea_estudo_envio` (`id_envio`, `id_estudo`, `matricula`, `data_envio`, `arquivo`, `tentativa`) VALUES (NULL, '$get_id_estudo', '$user_usuario', NOW(), '$nome_final', '$tentativa');");
	echo "<script language=\"javascript\">
