...
if($_SERVER["REQUEST_METHOD"] == "POST") {
	...
	$endereco = strtoupper($_POST["rua"])." N�".$_POST["num"]; 
	...
	$end_fin = strtoupper($_POST["rua_fin"])." N�".$_POST["num_fin"];
	...
	$end_fia = strtoupper($_POST["rua_fia"])." N�".$_POST["num_fia"];
...
nome_conj='$nome_conj', nasc_conj='$nasc_conj',cpf_conj='$cpf_conj', rg_conj='$rg_conj',nacio_conj='$nacio_conj',nacio_fia='$nacio_fia' WHERE codigo = $id");
		...
		if(mysql_errno() == 1062) {
			...
			echo "N�o foi poss�vel atualizar os dados.";
			exit;
		}	
	}
...
<table align="center" width="70%" border="0">
  ...
  <td>Celular</td>
  <td><input id="celular"  style="width:300px" name="celular" type="text" value="<?php echo $dados["celular"]; ?>" placeholder="Informe o N� do seu celular" required onKeyPress="return arrumaEnter(this, event)"/></td>
  </tr>
 <tr>
   <td>Nacionalidade</td>
  ...
  <td><input name="mae"  style="width:300px" type="text" id="mae" value="<?php echo $dados["mae"]; ?>" placeholder="Nome do M�e" required style="text-transform:uppercase" onKeyPress="return arrumaEnter(this, event)"/></td>
  </tr>
  <tr> 
...
<tr> 
  ...
  <tr>
    <td>Nome</td>
    <td><input name="nome_fin"  style="width:300px" type="text" id="nome_fin" placeholder="Nome Completo do Respons�vel Financeiro" value="<?php echo $dados["nome_fin"]; ?>" required style="text-transform:uppercase" onKeyPress="return arrumaEnter(this, event)"/></td>
    <td>Data de Nascimento</td>
  ...
  <tr>
    <td>CPF</td>
    <td><input name="cpf_fin"  style="width:300px" type="text" id="cpf_fin" placeholder="CPF do Respons�vel Financeiro" value="<?php echo $dados["cpf_fin"]; ?>" required onKeyPress="return arrumaEnter(this, event)"/></td>
    <td>RG</td>
    <td><input name="rg_fin"  style="width:300px" type="text" id="rg_fin" placeholder="RG do Respons�vel Financeiro" value="<?php echo $dados["rg_fin"]; ?>" required onKeyPress="return arrumaEnter(this, event)"/></td>
  </tr>
  <tr>
    <td height="28">CEP</td>
...
<td>Telefone</td>
<td><input id="tel_fin"  style="width:300px" name="tel_fin" type="text" value="<?php echo $dados["tel_fin"]; ?>" placeholder="Telefone do Respons�vel Financeiro" required onKeyPress="return arrumaEnter(this, event)"/></td>
</tr>
<tr>
<td>Complemento</td>
...
<tr>
<td>E-mail</td>
<td><input id="email_fin"  style="width:300px" name="email_fin" type="text" placeholder="E-mail do Respons�vel Financeiro" value="<?php echo strtolower($dados["email_fin"]); ?>" onKeyPress="return arrumaEnter(this, event)"/></td>                       
</tr>
<tr> 
  <td colspan="4" bgcolor="#CCCCCC"><center>
  ...
  <tr>
    <td>Nome</td>
    <td><input name="nome_fia" readonly  style="width:300px" type="text" id="nome_fia" value="<?php echo $dados["nome_fia"]; ?>" placeholder="Nome Completo do Fiador" style="text-transform:uppercase" onKeyPress="return arrumaEnter(this, event)"/></td>
    <td>Data de Nascimento</td>
    <td><input name="nasc_fia" readonly  style="width:300px" type="text" id="nasc_fia" value="<?php echo $dados["nasc_fia"]; ?>" placeholder="Data de Nascimento" onKeyPress="return arrumaEnter(this, event)"/></td>
  </tr>
  <tr>
    <td>CPF</td>
    <td><input name="cpf_fia"  readonly style="width:300px" type="text" id="cpf_fia" value="<?php echo $dados["cpf_fia"]; ?>" placeholder="CPF do Fiador" onKeyPress="return arrumaEnter(this, event)"/></td>
    <td>RG</td>
    <td><input name="rg_fia" readonly style="width:300px" type="text" id="rg_fia" value="<?php echo $dados["rg_fia"]; ?>" placeholder="RG do Fiador" onKeyPress="return arrumaEnter(this, event)"/></td>
  </tr>
  
  <tr>
    <td height="28">CEP</td>
    <td><input id="cep_fia" readonly style="width:300px" name="cep_fia" type="text" maxlength="9" value="<?php echo $dados["cep_fia"]; ?>" placeholder="Informe o CEP" onKeyPress="return arrumaEnter(this, event)"/></td>
    <td>Rua</td>
    <td><input id="rua_fia" readonly style="width:300px" name="rua_fia" type="text" value="<?php echo $dados["end_fia"]; ?>" placeholder="Nome da Rua / Logradouro" style="text-transform:uppercase" onKeyPress="return arrumaEnter(this, event)"/><input id="num_fia" name="num_fia" type="text" value="" placeholder="N�" style="text-transform:uppercase; width:30px;" onKeyPress="return arrumaEnter(this, event)"/></td>
  </tr>
  <tr>
    <td>Cidade</td>
    <td><input id="cidade_fia" readonly style="width:300px" name="cidade_fia" type="text" value="<?php echo $dados["cidade_fia"]; ?>" placeholder="Informe a Cidade" style="text-transform:uppercase" onKeyPress="return arrumaEnter(this, event)"/></td>
<td>UF</td>
<td><input id="uf_fia" readonly  style="width:300px" name="uf_fia" type="text" value="<?php echo $dados["uf_fia"]; ?>" placeholder="Informe a UF" style="text-transform:uppercase" onKeyPress="return arrumaEnter(this, event)"/></td>
</tr>
<tr>

<td>Bairro</td>
<td><input id="bairro_fia" readonly  style="width:300px" name="bairro_fia" value="<?php echo $dados["bairro_fia"]; ?>" type="text" placeholder="Informe o Bairro" style="text-transform:uppercase" onKeyPress="return arrumaEnter(this, event)"/></td>
<td>Nacionalidade</td>
<td><input id="nacio_fia" readonly  style="width:300px" name="nacio_fia" type="text" value="<?php echo $dados["nacio_fia"]; ?>" placeholder="Nacionalidade" style="text-transform:uppercase" onKeyPress="return arrumaEnter(this, event)"/></td>
</tr>
  

<tr>
<td>Telefone</td>
<td><input id="tel_fia" readonly style="width:300px" name="tel_fia" type="text" value="<?php echo $dados["tel_fia"]; ?>" placeholder="Telefone do Fiador" onKeyPress="return arrumaEnter(this, event)"/></td>
<td>E-mail</td>
<td><input id="email_fia" readonly  style="width:300px" name="email_fia" value="<?php echo $dados["email_fia"]; ?>" type="text" placeholder="E-mail do Fiador" onKeyPress="return arrumaEnter(this, event)"/></td>
                            
</tr>

<tr>
    <td>C&ocirc;njuge</td>
    <td><input name="nome_conj" readonly  style="width:300px" type="text" id="nome_conj" value="<?php echo $dados["nome_conj"]; ?>" placeholder="C�njuge do Fiador" style="text-transform:uppercase" onKeyPress="return arrumaEnter(this, event)"/></td>
    <td>Data de Nascimento</td>
    <td><input name="nasc_conj" readonly  style="width:300px" type="text" id="nasc_conj"value="<?php echo $dados["nasc_conj"]; ?>" placeholder="Data de Nascimento" onKeyPress="return arrumaEnter(this, event)"/></td>
  </tr>
  <tr>
    <td>CPF</td>
    <td><input name="cpf_conj" readonly  style="width:300px" type="text" id="cpf_conj" value="<?php echo $dados["cpf_conj"]; ?>" placeholder="CPF do C�njuge" onKeyPress="return arrumaEnter(this, event)"/></td>
    <td>RG</td>
    <td><input name="rg_conj" readonly  style="width:300px" type="text" id="rg_conj" value="<?php echo $dados["rg_conj"]; ?>" placeholder="RG do C�njuge" onKeyPress="return arrumaEnter(this, event)"/></td>
  </tr>
  <tr>
   <td>Nacionalidade</td>
   <td><input name="nacio_conj" readonly  style="width:300px" type="text" id="nacio_conj" value="<?php echo $dados["nacio_conj"]; ?>" placeholder="Nacionalidade do C�njuge" style="text-transform:uppercase" onKeyPress="return arrumaEnter(this, event)"/></td>
  </tr>
