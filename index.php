...
if (isset($_POST['usuario'])) {
  ...
  if ($loginFoundUser) {
    ...
    header("Location: " . $MM_redirectLoginSuccess );
      func_gravar_log($loginUsername, 01,'Acessou o sistema.', $_SERVER["REMOTE_ADDR"]);
  }
  else {
    header("Location: ". $MM_redirectLoginFailed );
      func_gravar_log($loginUsername, 02,'Acesso negado. Usuário / senha inválidos.', $_SERVER["REMOTE_ADDR"]);
  }
}
}
if(isset($_GET["erro"])){
